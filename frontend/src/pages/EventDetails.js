...
const EventDetails = () => {
  ...
  const handlePaymentSuccess = async (paymentData) => {
    ...
    if (event) {
      setEvent({ ...event, ticketLink: newAvailableTickets.toString() });
    }
  ...
  return (
    <div className="event-details-page" style={{ '--event-bg': `url(${event.poster})` }}>
        ...
        <div className="event-content">
                      ...
                      {editingComment === comment._id ? (
                        <div className="comment-edit">
                          ...
                          <div className="edit-actions">
                            <button onClick={() => handleSaveEdit(comment._id)} className="save-edit-btn">
                              <FaCheck />
                            </button>
          ...
          <div className="event-right">
            ...
            <div className="event-info">
              ...
              {event.ticketLink && (
                <button onClick={handleBuyTicketsClick} className="buy-tickets-link">
                  Buy Tickets
                </button>
              )}
            </div>
